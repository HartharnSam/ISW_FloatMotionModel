%%run_lab_FMM - Parsing Script for DJL Data into the FMM
% 
%
clc; clearvars; close all;
LfLambda = 2.4/1.4712;
isRecalculateDJL = false; % If there's already a DJL.mat file in the current folder, load it. If not, re-calculate the DJL wave
